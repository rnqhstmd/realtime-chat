...
| BONUS-4 | 운영 대시보드 또는 메트릭 시각화 | ✅ | [#7](https://github.com/rnqhstmd/realtime-chat/pull/7) Prometheus+Grafana 스택(docker compose 통합), 프로비저닝 대시보드 7패널(projection lag/stream·outbox rate/DLQ/HTTP/JVM) |
